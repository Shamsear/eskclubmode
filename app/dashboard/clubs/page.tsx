  ...
  return (
    <div className="space-y-6">
      ...
      <Link href="/dashboard/clubs/new" className="lg:hidden">
        <button 
          className="fixed bottom-20 right-6 z-40 px-5 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-full shadow-2xl hover:shadow-3xl transition-all flex items-center gap-2 font-medium text-sm hover:scale-105 active:scale-95"
